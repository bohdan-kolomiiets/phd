...
class CNN(nn.Module):
    ...
    def fit(self, dataloader_dictionary, verbose, checkpoints_path):
        ...
        early_stopping = EarlyStopping(patience=4, delta_pct=0.02, verbose=True, path=checkpoints_path)
...
def get_experiment_name(): 
    ...
    return f'Split by samples. subjects={num_subjects},num_epochs={num_epochs},batch_size={batch_size},{optimizer_config},{scheduler_config}'
